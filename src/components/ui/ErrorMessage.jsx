...
const ErrorMessage = ({
  ...
  const getIcon = () => {
    const icons = {
      error: (
        <svg viewBox="0 0 100 100" fill="currentColor" className="error-icon">
      ...
      <div className="error-content">
        ...
        <div className="error-actions">
          {onRetry && (
            ...
            >
              <svg viewBox="0 0 100 100" fill="currentColor" className="retry-icon">
          ...
          {dismissible && (
            ...
            >
              <svg viewBox="0 0 100 100" fill="currentColor" className="dismiss-icon">
